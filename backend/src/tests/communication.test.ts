...
function canAccessChat(userId: string, request: MockChatRequest): boolean {
...
function getPublicDonorCard(donor: typeof donorPrivateProfile) {
...
function getSecureContact(callerId: string, request: typeof mockRequest, donor: typeof donorPrivateProfile) {
...
function isCommunicationAllowed(userA: string, userB: string): boolean {
