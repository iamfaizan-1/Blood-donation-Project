...
async function testDatabase() {
    ...
    console.log('==================================================\n');
    console.log('Target MongoDB URI:', env_1.config.mongoUri.replace(/:([^@]+)@/, ':****@'));
    ...
    try {
        ...
        const retrievedUser = await User_1.User.findById(testUser._id);
        ...
        await User_1.User.findByIdAndDelete(testUser._id);
        const checkDeleted = await User_1.User.findById(testUser._id);
        if (checkDeleted) {
